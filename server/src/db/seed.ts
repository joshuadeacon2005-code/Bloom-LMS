...
async function seed() {
  ...
  await db
    ...
    .values([
      ...
      },
      {
        name: 'No Pay Leave',
        code: 'NPL',
        description: 'Unpaid leave approved by HR',
        isPaid: false,
        requiresAttachment: false,
        regionId: null,
      },
      {
        ...
        code: 'CCL',
        description: 'Government-mandated child care leave (Singapore)',
        isPaid: true,
        requiresAttachment: false,
        maxDaysPerYear: 6,
  ...
  const policies: PolicyRow[] = [
    ...
    // No Pay Leave (all regions — 0 entitlement, taken as needed)
    { leaveTypeCode: 'NPL', regionCode: 'HK', entitlementDays: '0', carryOverMax: '0', probationMonths: 0 },
    { leaveTypeCode: 'NPL', regionCode: 'SG', entitlementDays: '0', carryOverMax: '0', probationMonths: 0 },
    { leaveTypeCode: 'NPL', regionCode: 'MY', entitlementDays: '0', carryOverMax: '0', probationMonths: 0 },
