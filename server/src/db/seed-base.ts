...
export async function seedBaseData(): Promise<void> {
  ...
  try {
    ...
    if (parseInt(regionCheck.rows[0].cnt) >= 7) {
    ...
    const policies = [
      ...
      ['AL', 'ID', '12', '0', 12], ['AL', 'CN', '5', '0', 12], ['AL', 'AU', '20', '20', 0], ['AL', 'NZ', '20', '20', 12],
      ['SL', 'HK', '14', '0', 1], ['SL', 'SG', '14', '0', 3], ['SL', 'MY', '14', '0', 0],
      ['SL', 'ID', '12', '0', 0], ['SL', 'CN', '12', '0', 0], ['SL', 'AU', '10', '10', 0], ['SL', 'NZ', '10', '20', 0],
      ['ML', 'HK', '84', '0', 3], ['ML', 'SG', '112', '0', 3], ['ML', 'MY', '60', '0', 3],
      ['ML', 'ID', '90', '0', 0], ['ML', 'CN', '98', '0', 0], ['ML', 'AU', '365', '0', 12], ['ML', 'NZ', '365', '0', 6],
      ['PL', 'HK', '5', '0', 3], ['PL', 'SG', '14', '0', 3], ['PL', 'MY', '3', '0', 12],
      ['PL', 'ID', '2', '0', 0], ['PL', 'CN', '15', '0', 0], ['PL', 'AU', '5', '0', 12], ['PL', 'NZ', '10', '0', 6],
      ['CL', 'HK', '5', '0', 0], ['CL', 'SG', '3', '0', 0], ['CL', 'MY', '3', '0', 0],
      ['CL', 'ID', '2', '0', 0], ['CL', 'CN', '3', '0', 0], ['CL', 'AU', '5', '0', 0], ['CL', 'NZ', '3', '0', 0],
      ['CCL', 'SG', '6', '0', 3], ['CCL', 'MY', '7', '0', 3], ['CCL', 'AU', '5', '0', 12], ['CCL', 'NZ', '5', '0', 0],
      ['COMP_LEAVE', 'HK', '0', '5', 0], ['COMP_LEAVE', 'SG', '0', '5', 0], ['COMP_LEAVE', 'MY', '0', '5', 0],
      ['COMP_LEAVE', 'ID', '0', '5', 0], ['COMP_LEAVE', 'CN', '0', '5', 0],
    ...
    const holidays = [
      ...
      ['Ching Ming Festival', '2026-04-05', 'HK'], ['Good Friday', '2026-04-03', 'HK'],
      ['Day After Good Friday', '2026-04-04', 'HK'], ['Easter Monday', '2026-04-06', 'HK'],
      ...
      ['Day After Mid-Autumn Festival', '2026-09-26', 'HK'], ['National Day', '2026-10-01', 'HK'],
      ['Chung Yeung Festival', '2026-10-11', 'HK'], ['Christmas Day', '2026-12-25', 'HK'],
      ['Boxing Day', '2026-12-26', 'HK'],
