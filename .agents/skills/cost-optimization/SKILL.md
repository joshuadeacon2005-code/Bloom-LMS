...
| Field      | Value                                           |
| ---------- | ----------------------------------------------- |
| Identifier | `agent-skills-hub-agent-skills-hub-cost-optimization`                                |
| Version    | 1.0.1                                     |
...
Provides a systematic, implementation-focused approach to reducing cloud costs across AWS, Azure, and GCP. Key features include visibility (cost allocation tags, budget alerts, cost dashboards, and third-party cost tools), right-sizing (utilization analysis, autoscaling, downsizing, and idle resource removal), pricing-model guidance (reserved capacity, savings plans/committed-use discounts, and spot/preemptible instance strategies), and architecture optimizations (use of managed services, caching, data-transfer reduction, and storage lifecycle policies). Use cases include reducing monthly cloud spend, enforcing cost governance and budgets, right-sizing compute and storage, and optimizing multi-cloud deployments. Core advantages are actionable steps, verification and validation guidance, concrete AWS examples (RIs, Savings Plans, Spot, and S3 lifecycle policies), and links to an implementation playbook for detailed examples.
...
```bash
npx -y @lobehub/market-cli skills install agent-skills-hub-agent-skills-hub-cost-optimization
```
...
npx -y @lobehub/market-cli skills install agent-skills-hub-agent-skills-hub-cost-optimization --agent open-claw

# Claude Code (installs to ./.claude/skills/)
npx -y @lobehub/market-cli skills install agent-skills-hub-agent-skills-hub-cost-optimization --agent claude-code

# Codex (installs to ./.agents/skills/)
npx -y @lobehub/market-cli skills install agent-skills-hub-agent-skills-hub-cost-optimization --agent codex

# Cursor (installs to ./.cursor/skills/)
npx -y @lobehub/market-cli skills install agent-skills-hub-agent-skills-hub-cost-optimization --agent cursor
```

Install a specific version:

```bash
npx -y @lobehub/market-cli skills install agent-skills-hub-agent-skills-hub-cost-optimization --version 1.0.1
```
...
```bash
npx -y @lobehub/market-cli skills rate agent-skills-hub-agent-skills-hub-cost-optimization --score <1-5>
```
...
```bash
npx -y @lobehub/market-cli skills comment agent-skills-hub-agent-skills-hub-cost-optimization -c "Your feedback here" --rating <1-5>
```
...
```bash
npx -y @lobehub/market-cli skills uncomment agent-skills-hub-agent-skills-hub-cost-optimization
```
...
```bash
npx -y @lobehub/market-cli skills comments agent-skills-hub-agent-skills-hub-cost-optimization
```
