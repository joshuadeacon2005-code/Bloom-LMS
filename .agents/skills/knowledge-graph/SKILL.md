...
| Field      | Value                                           |
| ---------- | ----------------------------------------------- |
| Identifier | `jdrhyne-agent-skills-knowledge-graph`                                |
| Version    | 1.0.1                                     |
| Author     | jdrhyne                                 |
| Category   | notes-pkm                                    |
| Installs   | 6                                |
...
**GitHub:** [jdrhyne/agent-skills](https://github.com/jdrhyne/agent-skills) — ⭐ 180 | Forks: 19
...
Three-Layer Memory System organizes personal and team knowledge by combining automatic fact extraction, an entity-based knowledge graph, and weekly synthesis. It ingests notes, documents, emails and web clippings to capture atomic facts, extracts entities and relationships, and maps them into a persistent knowledge graph that represents people, projects, places, and topics. Every entity maintains a living summary that updates as new facts arrive; weekly synthesis produces concise digests and actionables across areas of life or work. Use cases include personal knowledge management, project tracking, research, client/CRM oversight, and study review. Core advantages are precise retrieval via entity context, reduced cognitive overhead through atomic facts, continuous situational awareness from living summaries, temporal insight from weekly syntheses, and integrations for search, calendar and export.
...
```bash
npx -y @lobehub/market-cli skills install jdrhyne-agent-skills-knowledge-graph
```
...
npx -y @lobehub/market-cli skills install jdrhyne-agent-skills-knowledge-graph --agent open-claw

# Claude Code (installs to ./.claude/skills/)
npx -y @lobehub/market-cli skills install jdrhyne-agent-skills-knowledge-graph --agent claude-code

# Codex (installs to ./.agents/skills/)
npx -y @lobehub/market-cli skills install jdrhyne-agent-skills-knowledge-graph --agent codex

# Cursor (installs to ./.cursor/skills/)
npx -y @lobehub/market-cli skills install jdrhyne-agent-skills-knowledge-graph --agent cursor
```

Install a specific version:

```bash
npx -y @lobehub/market-cli skills install jdrhyne-agent-skills-knowledge-graph --version 1.0.1
```
...
```bash
npx -y @lobehub/market-cli skills rate jdrhyne-agent-skills-knowledge-graph --score <1-5>
```
...
```bash
npx -y @lobehub/market-cli skills comment jdrhyne-agent-skills-knowledge-graph -c "Your feedback here" --rating <1-5>
```
...
```bash
npx -y @lobehub/market-cli skills uncomment jdrhyne-agent-skills-knowledge-graph
```
...
```bash
npx -y @lobehub/market-cli skills comments jdrhyne-agent-skills-knowledge-graph
```
