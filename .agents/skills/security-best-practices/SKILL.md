...
| Field      | Value                                           |
| ---------- | ----------------------------------------------- |
| Identifier | `tech-leads-club-agent-skills-security-best-practices`                                |
| Version    | 1.0.2                                     |
...
**GitHub:** [tech-leads-club/agent-skills](https://github.com/tech-leads-club/agent-skills) — ⭐ 1612 | Forks: 165
...
This Skill performs language- and framework-specific security best-practice reviews for Python, JavaScript/TypeScript, and Go codebases, and returns prioritized, actionable remediation guidance and secure-by-default patterns. Use it when you explicitly request security best-practices guidance, a security review or report, or secure-by-default coding help. Features include identification of common weaknesses (input validation, injection risks, XSS, CSRF, unsafe deserialization, insecure crypto, improper error handling, secrets leakage), framework-specific configuration checks (e.g., Django/Flask, Express, popular Go web frameworks), secure authentication/authorization patterns, dependency and supply-chain hardening suggestions, example code fixes, and references to standards like OWASP. Deliverables are concise findings, remediation steps, and example code. Do not use for general code review, debugging, threat modeling, or non-security tasks.
...
```bash
npx -y @lobehub/market-cli skills install tech-leads-club-agent-skills-security-best-practices
```
...
npx -y @lobehub/market-cli skills install tech-leads-club-agent-skills-security-best-practices --agent open-claw

# Claude Code (installs to ./.claude/skills/)
npx -y @lobehub/market-cli skills install tech-leads-club-agent-skills-security-best-practices --agent claude-code

# Codex (installs to ./.agents/skills/)
npx -y @lobehub/market-cli skills install tech-leads-club-agent-skills-security-best-practices --agent codex

# Cursor (installs to ./.cursor/skills/)
npx -y @lobehub/market-cli skills install tech-leads-club-agent-skills-security-best-practices --agent cursor
```

Install a specific version:

```bash
npx -y @lobehub/market-cli skills install tech-leads-club-agent-skills-security-best-practices --version 1.0.2
```
...
```bash
npx -y @lobehub/market-cli skills rate tech-leads-club-agent-skills-security-best-practices --score <1-5>
```
...
```bash
npx -y @lobehub/market-cli skills comment tech-leads-club-agent-skills-security-best-practices -c "Your feedback here" --rating <1-5>
```
...
```bash
npx -y @lobehub/market-cli skills uncomment tech-leads-club-agent-skills-security-best-practices
```
...
```bash
npx -y @lobehub/market-cli skills comments tech-leads-club-agent-skills-security-best-practices
```
